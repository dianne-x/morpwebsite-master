...
INSERT INTO `character_species` (`id`, `specie`) VALUES
(1, 'Human'),
(2, 'Elf'),
(3, 'Dwarf'),
(4, 'Orc'),
...
(3, 'f3dbf20964df6e1f1c9edfd356762b4a', 3, 0, 0),
(4, '2fe88b43124bf5bb3ec1401eef8ac986', 5, 1, 1),
(7, 'b0f1c66cd0fcfb2348515a39bac355f7', 3, 0, 0);
...
(3, 1, 0, 0, 'asdasd', NULL, 2, NULL, NULL, 0, NULL, 0, NULL, 2, NULL, NULL, NULL, 2, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
(4, 3, 0, 0, 'dasdwa', NULL, 2, NULL, NULL, 0, NULL, 0, NULL, 3, NULL, NULL, NULL, 2, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
(5, 1, 0, 0, 'aley csigér', NULL, 2, NULL, NULL, 0, NULL, 0, NULL, 5, NULL, NULL, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
(6, 1, 0, 0, 'KKK', NULL, 1, NULL, NULL, 0, NULL, 0, NULL, 3, NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
(7, 1, 0, 0, 'mtdrg', NULL, 2, NULL, NULL, 0, NULL, 0, NULL, 3, NULL, NULL, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
(8, 1, 0, 0, 'awdsawd', NULL, 1, NULL, NULL, 0, NULL, 0, NULL, 1, NULL, NULL, NULL, 2, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
(9, 1, 0, 0, 'tzhth', NULL, 3, NULL, NULL, 0, NULL, 0, NULL, 3, NULL, NULL, NULL, 3, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL),
(10, 7, 1, 0, 'erdos barnabas', NULL, 2, NULL, NULL, 0, NULL, 0, NULL, 4, NULL, NULL, NULL, 2, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL);
...
CREATE TABLE `user_character_need` (
  `server_id` int(11) NOT NULL,
  `birthdate_need` tinyint(1) DEFAULT 0,
  `deathdate_need` tinyint(1) DEFAULT 0,
  `resurrected_date_need` tinyint(1) DEFAULT 0,
  `species_need` tinyint(1) DEFAULT 0,
  `occupation_need` tinyint(1) DEFAULT 0,
  `affiliation_need` tinyint(1) DEFAULT 0,
  `nationality_need` tinyint(1) DEFAULT 0,
  `powers_need` tinyint(1) DEFAULT 0,
  `weaknesses_need` tinyint(1) DEFAULT 0,
  `used_item_need` tinyint(1) DEFAULT 0,
  `family_need` tinyint(1) DEFAULT 0,
  `universe_need` tinyint(1) DEFAULT 0,
  `fc_need` tinyint(1) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- AUTO_INCREMENT a táblához `user_character`
--
ALTER TABLE `user_character`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
