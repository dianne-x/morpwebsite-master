...
INSERT INTO `user_character` (`id`, `servermember_id`, `is_verified`, `is_oc`, `character_name`, `nickname`, `gender_id`, `character_pic_path`, `birthdate`, `died`, `deathdate`, `resurrected`, `resurrected_date`, `species_id`, `occupation`, `affilation`, `nationality`, `status_id`, `story_id`, `bio`, `powers`, `weaknesses`, `used_item`, `family`, `universe`, `fc_id`) VALUES
