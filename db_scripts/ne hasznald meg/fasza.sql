...
CREATE TABLE `user_character` (
  ...
  `powers` varchar(3000) DEFAULT NULL,
  `weaknesses` varchar(3000) DEFAULT NULL,
  `used_item` varchar(3000) DEFAULT NULL,
  `family` varchar(3000) DEFAULT NULL,
  `universe` varchar(3000) DEFAULT NULL,
