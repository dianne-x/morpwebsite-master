...
const CharacterTile = (props) => {
    return (
        <li className={(!props.verified ? "not-verified" : "")}>
            <div className="info">
                <img src={`http://localhost/morpwebsite-master/src/pictureData/userPictures/${props.pic_path}`}/>
                <p>{props.name}</p>
            </div>
            <div className="modify">
                ...
                <button title="delete" className="delete"><FontAwesomeIcon icon={faTrash} /></button>
            </div>
        </li>
    );
};
